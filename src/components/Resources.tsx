  ...
  return (
    <section id="resources" className="py-20 px-6 bg-warm-white">
      <div className="container mx-auto max-w-7xl">
          ...
          {resources.map((resource) => {
            ...
            return (
              <a
                key={resource.title}
                href={resource.link}
                className="bg-white/80 backdrop-blur-sm p-6 rounded-pebble shadow-lg border border-amber-100/50 hover:shadow-xl transition-all hover:-translate-y-1 group flex items-start gap-4"
              >
                <div className="w-14 h-14 bg-amber-700 rounded-pebble flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform shadow-md">
        ...
        <div className="mt-12 bg-amber-800 p-8 rounded-pebble-lg text-white text-center shadow-xl">
          <div>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="tel:988" className="bg-white text-amber-800 px-8 py-3 rounded-pebble font-bold hover:bg-white/90 hover:shadow-lg transition-all border-2 border-white">
                Call 988 (US)
              </a>
              <a href="tel:911" className="bg-white text-amber-800 px-8 py-3 rounded-pebble font-bold hover:bg-white/90 hover:shadow-lg transition-all border-2 border-white">
                Emergency: 911
              </a>
              <a href="#" className="bg-white text-amber-800 px-8 py-3 rounded-pebble font-bold hover:bg-white/90 transition-all border-2 border-white">
