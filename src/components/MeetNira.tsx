...
// Define the new dark mode colors for consistency
...
export default function MeetNira() {
  ...
  return (
    <section className={`py-12 px-6 bg-gradient-to-b from-mint-50/20 via-warm-white to-sage-50/30 dark:from-[${darkBackground}] dark:via-[${darkBackground}] dark:to-[${darkBackground}] relative overflow-hidden`}>
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative">
            {/* Chat Container - Uses new darkBackground color */}
            <div className={`relative z-10 bg-white/70 dark:bg-[${darkBackground}] backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-lavender-100/30 dark:border-[#283647] overflow-hidden`}>
              <div className="bg-forest dark:bg-[#1c2533] p-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  {/* NIRA Bot Icon - Uses new darkAccent color for background and shadow */}
                  <div className={`w-14 h-14 bg-white dark:bg-[${darkAccent}] rounded-full flex items-center justify-center shadow-lg dark:shadow-[0_0_20px_rgba(90,127,106,0.5)] animate-pulse-gentle`}>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      {/* Status Dot - Uses new darkAccent color for background and shadow */}
                      <div className={`w-2.5 h-2.5 bg-white dark:bg-[${darkAccent}] rounded-full animate-pulse shadow-[0_0_8px_rgba(90,127,106,0.8)]`}></div>
              ...
              {/* Chat Messages Area - Uses new darkBackground color */}
              <div className={`p-8 space-y-6 h-[450px] overflow-y-auto bg-gradient-to-b from-lavender-50/20 via-warm-white/50 to-paleblue-50/20 dark:from-[${darkBackground}] dark:via-[${darkBackground}] dark:to-[${darkBackground}]`}>
                {messages.slice(0, visibleMessages).map((message, index) => (
                  ...
                  >
                    ...
                    <div className={`w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm ${
                      message.type === 'bot'
                        ? `bg-gradient-to-br from-sage-300/60 to-mint-300/60 dark:bg-[${darkAccent}] backdrop-blur-sm dark:shadow-[0_0_15px_rgba(90,127,106,0.4)]`
                    ...
                    <div className={`max-w-[75%] ${message.type === 'user' ? 'items-end' : 'items-start'} flex flex-col`}>
                      ...
                      <div className={`px-6 py-4 rounded-[1.5rem] ${
                        message.type === 'bot'
                          ? `bg-white/80 dark:bg-[${darkBackground}] backdrop-blur-sm text-soft-gray dark:text-[${darkAccent}] shadow-sm border border-lavender-100/40 dark:border-[${darkAccent}]/30 dark:shadow-[0_0_10px_rgba(90,127,106,0.2)]`
              ...
              {/* Input Bar - Uses new darkBackground color */}
              <div className={`p-6 bg-white/60 dark:bg-[${darkBackground}] backdrop-blur-md`}>
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    className={`flex-1 px-6 py-3.5 rounded-[2rem] border border-forest dark:border-[#283647] focus:outline-none focus:ring-2 focus:ring-forest/30 dark:focus:ring-[${darkAccent}]/50 focus:border-forest dark:focus:border-[${darkAccent}] transition-all text-sm text-soft-gray dark:text-white placeholder:text-gentle-gray/50 dark:placeholder:text-[#B0BED0] bg-white dark:bg-[#1c2533]`}
                    disabled
                  />
                  {/* Send Button - Uses new darkAccent color for background and shadow */}
                  <button className={`w-12 h-12 bg-gradient-to-r from-sage-400 to-mint-400 dark:bg-[${darkAccent}] text-white dark:text-[#0a0f16] rounded-full hover:shadow-lg dark:shadow-[0_0_20px_rgba(90,127,106,0.5)] dark:hover:shadow-[0_0_30px_rgba(90,127,106,0.7)] hover:scale-105 transition-all flex items-center justify-center flex-shrink-0`}>
